...
public static class LoadTestEndpoints
{
    public static void Map(WebApplication app)
    {
        ...
        app.MapGet("/api/demo/cpu", () =>
        {
            ...
            var result = Fib(n);
            return Results.Ok(new { message = $"Fibonacci({n}) = {result}", timestamp = DateTime.UtcNow });
        });
    }
}